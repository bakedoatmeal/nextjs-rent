...
const CreateRentLogMutation = gql`
  mutation($rentalType: String!, $rentalSize: String!, $address: String!, $year: Int!, $rent: Int!) {
    createRentLog(rentalType: $rentalType, rentalSize: $rentalSize, address: $address, year: $year, rent: $rent) {
      rentalType
      rentalSize
      address
      year
...
export default function Home() {
  ...
  const onSubmit = async (data) => {
    const {rentalType, rentalSize, address, year, rent} = data
    const variables = {rentalType, rentalSize, address, year, rent}
